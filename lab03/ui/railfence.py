...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(210, 432, 111, 31))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(40, 350, 121, 20))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(70, 230, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.txt_plaintext.setGeometry(QtCore.QRect(160, 100, 511, 71))
        self.txt_plaintext.setObjectName("txt_plaintext")
        self.txt_ciphertext = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_ciphertext.setGeometry(QtCore.QRect(160, 330, 511, 71))
        self.txt_ciphertext.setObjectName("txt_ciphertext")
        self.txt_key = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(160, 230, 521, 31))
        self.txt_key.setObjectName("txt_key")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(460, 430, 111, 31))
